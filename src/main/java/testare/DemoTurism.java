...
public class DemoTurism {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //Constructor cu parametri efectivi
        System.out.println("\nConstructor cu parametri efectivi");
        ParcPublic parc1 = new ParcPublic("Gradina Publica", "Strada Domneasca", (new int[]{10, 18}), 4.5f, (new double[]{8.5, 10.5}), 988.0, 5, 7, 10, 70);
...
//---Muzeu
        ...
        vecMuzeu.add(new Muzeu("Muzeul Stiintei in Robotica", "Braila", (new int[]{12, 15}), 3.5f, (new double[]{2, 8, 6.5, 5.5, 7.7, 4.4}), "Tehnologie", 1842, 764));
        ...
        vecParcPublic.add(new ParcPublic("Gradina Publica", "Strada Domneasca", (new int[]{12, 18}), 4.1f, (new double[]{3.5, 11.3, 8.5, 10.5}), 988.0, 5, 7, 11, 10));
        ...
        vecParcPublic.add(new ParcPublic("Parcul Rizer", "Strada Traian", (new int[]{10, 19}), 2.4f, (new double[]{3.5, 8.2, 3.7, 5.4}), 988.0, 4, 7, 10, 0));
        ...
        System.out.println("\n\n--------Conditie Muzeu--------\n -incepe de la 10 si e de tipul Istorie\n");
        Muzeu.conditieMuzeu(vecMuzeu, 10, "Istorie");
        
        System.out.println("\n\n--------Conditie Casa Memoriala--------\n -are ghid    1921->prezent\n");
        CasaMemoriala.conditieCasa(vecCasaMemoriala, true, 1921);
        
        System.out.println("\n\n--------Conditie Parc Public--------\n rating>3.5   -cu toalete disponibile  rating : 3.5-5\n");
        ParcPublic.conditieParc(vecParcPublic, 3.5f, true);
        
        System.out.println("\n\n--------Conditie Hotel--------\n rating>3.5   -fara piscina  -rating : 4.1-5\n");
        Hotel.AfisareRating(vectorHotel, 4.1f, false);
        
        System.out.println("\n\n--------Conditie Apartament--------\n 3 locuri   -cu aer conditionat\n");
        Apartament.AfisareNrloc(vectorApartament, 5, true);
       
        System.out.println("\n\n--------Conditie Restaurant--------\n -se aplica cod vestimentar   -cu terasa\n");
        Restaurant.Terasa_codvestimentar(vecRestaurant, true, true);
        
        System.out.println("\n\n--------Conditie Cafenea--------\n -are inclus sandwich   -dara servicii rapide\n");
        Cafenele.servire_sandwich(vecCafenele, true, false);
        
        System.out.println("\n\n--------Conditie Spital--------\n -include chirugie   -e de stat\n");
        Spital.AfisareDomeniu(vecSpital,"Chirurgie","Stat");
        
        System.out.println("\n\n--------Conditie Clinica--------\n -include chirugie   -programul sa inceapa de la 7\n");
         Clinica.AfisareServicii(vecClinica,"ORL",7);
          System.out.println("\n\n--------Conditie PPA--------\n -include cursuri   -pretul incepe de la 10 lei\n");
         PPA.AfisarePret(vecPPA,"Cursuri",10);
