...
public class Cafenele extends Restaurant
{
 ...
 public Cafenele(String nume,String adresa,float rating,int program[],boolean terasa,String meniulzilei/*mancare cafenea tip sandwich*/,String bauturi/*cafea,limonada,sucuri apa,frappe*/,double pret[],boolean serviciucoffe_to_go,boolean sandwich,boolean servirerapida)
 {
